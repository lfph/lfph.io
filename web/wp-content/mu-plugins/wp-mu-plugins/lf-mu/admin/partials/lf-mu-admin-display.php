...
<div class="wrap">
	...
	<form method="post" name="<?php echo esc_html( $this->plugin_name ); ?>"
		...
		$google_api_key = ( isset( $options['google_api_key'] ) && ! empty( $options['google_api_key'] ) ) ? esc_attr( $options['google_api_key'] ) : '';
		...
		<table class="form-table" role="presentation">
			<tbody>
				...
				<tr>
					<th scope="row"><label for="google_api_key">Google API key</label>
					</th>
					<td>
						<input type="text" class="google_api_key regular-text"
							id="<?php echo esc_html( $this->plugin_name ); ?>-google_api_key"
							name="<?php echo esc_html( $this->plugin_name ); ?>[google_api_key]"
