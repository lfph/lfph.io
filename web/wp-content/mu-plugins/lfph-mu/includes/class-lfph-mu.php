...
class Lfph_Mu {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Lfph_Mu_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'LFPH_MU_VERSION' ) ) {
			$this->version = LFPH_MU_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'lfph-mu';
	 ...
	 *
	 * - Lfph_Mu_Loader. Orchestrates the hooks of the plugin.
	 * - Lfph_Mu_I18n. Defines internationalization functionality.
	 * - Lfph_Mu_Admin. Defines all hooks for the admin area.
	 * - Lfph_Mu_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-lfph-mu-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-lfph-mu-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-lfph-mu-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-lfph-mu-public.php';

		$this->loader = new Lfph_Mu_Loader();
	 ...
	 *
	 * Uses the Lfph_Mu_I18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Lfph_Mu_Admin( $this->get_plugin_name(), $this->get_version() );
		...
		// Hooks to keep the lfph_speaker CPT in sync with Users of role "Speaker".
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Lfph_Mu_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Lfph_Mu_Loader    Orchestrates the hooks of the plugin.
	 */
