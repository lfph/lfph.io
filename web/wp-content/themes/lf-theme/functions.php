...
require_once 'includes/shortcode-a-projects.php';
...
/**
 * Increase preview time of Public Post Preview
 */
function lfe_ppp_custom_nonce_life() {
	return 86400 * 14; // 14 days.
}
add_filter( 'ppp_nonce_life', 'lfe_ppp_custom_nonce_life' );
