...
<div class="spotlight-box">
	...
	<div class="spotlight-text-wrapper">
		<a class="skew-box secondary margin-top-small centered" title="See more <?php echo esc_attr( $spotlight_type ); ?> spotlights" href="<?php echo esc_url( $spotlight_type_link ); ?>">LFPH
