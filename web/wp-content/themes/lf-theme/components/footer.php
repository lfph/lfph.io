...
<footer class="footer">
	...
	<div class="copyright-text">
				...
				<!--Removed while putting website into deep freeze mode-->
				<!--<p><a target="_blank" class="external" rel="noopener" href="https://github.com/lfph/lfph.io/issues/new?title=Your+issue&projects=lfph/lfph.io/1&body=From+URL%3A+<?php/* echo urlencode( get_permalink() ); */?>">Submit issue with this page on GitHub</a>.</p>-->
	</div>
