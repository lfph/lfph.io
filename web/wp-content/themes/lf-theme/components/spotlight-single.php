	...
	<article class="container wrap">
		...
		while ( have_posts() ) :
			...
			if ( $spotlight_type ) :
				...
				?>
		<a class="skew-box secondary centered margin-bottom-small" title="See more <?php echo esc_attr( $spotlight_type ); ?> spotlights" href="<?php echo esc_url( $spotlight_type_link ); ?>">LFPH
